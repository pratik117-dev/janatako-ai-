...
/**
 * About Page Component - Red Civic Theme
...
const About = () => {
  ...
  return (
    <article className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      {/* Hero Header */}
      <section className="relative overflow-hidden bg-gradient-to-r from-red-500 to-red-600 px-6 py-20 md:py-28">
        {/* Decorative elements */}
      ...
      <div className="mx-auto max-w-4xl px-6 py-16 md:py-20">
        ...
        <section className="mb-16 animate-fade-in-up">
          ...
          <div className="bg-white rounded-2xl border-2 border-gray-200 p-8 md:p-10 shadow-lg hover:border-red-500/30 transition-all duration-300">
        ...
        <section className="mb-16 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl border-2 border-red-200 p-8 md:p-10 shadow-lg">
            <div className="grid sm:grid-cols-2 gap-4">
              {whatIsNot.map((item, index) => (
                <div 
                  key={item.text}
                  className="flex items-center gap-3 bg-white rounded-xl p-4 border border-red-100 hover:border-red-300 transition-all duration-300 hover:shadow-md"
        ...
        <section className="mb-16 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-xl bg-red-100 flex items-center justify-center">
              <Cog className="text-red-600" size={24} />
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
              JAI किन आवश्यक छ?
            </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 md:p-10 text-white shadow-2xl relative overflow-hidden">
              ...
              <div className="relative space-y-6">
                ...
                <p className="text-lg leading-relaxed text-white/90 border-l-4 border-red-500 pl-4">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl border-2 border-gray-200 p-8 md:p-10 shadow-lg">
              <p className="text-lg leading-relaxed text-gray-700">
                ...
                <span className="font-bold text-red-600"> चार आयाममा</span>:
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {dimensions.map((item, index) => (
                <div 
                  key={item.title}
                  className="group relative bg-white rounded-2xl border-2 border-gray-200 p-6 md:p-8 shadow-lg hover:border-red-500/40 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  {/* Icon */}
        ...
        <section className="animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-white text-red-600 font-bold rounded-full hover:bg-gray-100 transition-all duration-300 hover:scale-105 shadow-lg">
